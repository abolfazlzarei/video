...
media.addEventListener('timeupdate', function () {
    ...
    timerBar.style = `background : linear-gradient(90deg,  rgb(220, 230, 34) ${barLength}%, #e1e1e1 0%);`
...
volumeProgressBarInput.addEventListener('input', function () {
    ...
    this.style = `background : linear-gradient(90deg,  rgb(220, 230, 34) ${this.value}%, #e1e1e1 0%);`
})
